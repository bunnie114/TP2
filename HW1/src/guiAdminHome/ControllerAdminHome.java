...
public class ControllerAdminHome {
	...
	*/
	...
	protected static void manageInvitations () {
	    ...
	    ViewManageInvitations.displayManageInvitations(ViewAdminHome.theStage, ViewAdminHome.theUser);
	...
	protected static void deleteUser() {
	    new DeleteUserDialog(ViewAdminHome.theStage, ViewAdminHome.theUser.getUserName());
	}
	 ...
	 * 
	 * <p> Description: Protected method that pulls the userlist from database then outputs shows a list in an alert for simplicity</p>
	 */
	protected static void listUsers() {
	    ...
	    if (users == null || users.size() <= 1) {
	        ...
	        alert.setTitle("List Users");
	        alert.setHeaderText("No Users Found");
	        alert.setContentText("There are no registered users in the system.");
	        alert.showAndWait();
	        return;
	    }
	    ...
	    message.append("Users currently in the system:\n\n");

	    // Skip index 0 ("<Select a User>")
	    for (int i = 1; i < users.size(); i++) {
	        message.append("- ").append(users.get(i)).append("\n");
	    }

	    // Show the users
	    Alert alert = new Alert(Alert.AlertType.INFORMATION);
	    alert.setTitle("List All Users");
	    alert.setHeaderText("Registered Users");
	    alert.setContentText(message.toString());
	    alert.getDialogPane().setPrefWidth(400); // prevents line wrapping
	    alert.showAndWait();
	}
