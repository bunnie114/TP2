...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
		...
		//sends the username into the username recognizer and returns an error message if there is one
		
		//be6e99
		
		int errMessage = UserNameRecognizer.checkForValidUserName(username);
		...
		if (errMessage != 0) {
			...
			switch(errMessage) {
			case 0:
				 ViewNewAccount.alertUsernameNotThere.showAndWait();
				 ViewNewAccount.text_Username.setText("");
			    break;
			  case 1:
				 ViewNewAccount.alertUsernameStartNotCharError.showAndWait();
				 ViewNewAccount.text_Username.setText("");
			    break;
			  case 2:
				  ViewNewAccount.alertUsernameLessThan4Error.showAndWait();
				  ViewNewAccount.text_Username.setText("");
			    break;
			  case 3:
				  ViewNewAccount.alertUsernameGreaterThan16Error.showAndWait();
				  ViewNewAccount.text_Username.setText("");
			    break;
			  case 4:
				  ViewNewAccount.alertUsernameCannotContainSymbolsError.showAndWait();
				  ViewNewAccount.text_Username.setText("");
			    break;
			  case 5:
				  ViewNewAccount.alertUsernameAfterPError.showAndWait();
				  ViewNewAccount.text_Username.setText("");
			    break;
			  default:
...
//		    switch (errMessage) {
//		        case 1:
//		            alert.setContentText("Username must start with a letter (A–Z or a–z).");
//		            break;
//		        case 2:
//		            alert.setContentText("Username must be at least 4 characters long.");
//		            break;
//		        case 3:
//		            alert.setContentText("Username must not exceed 16 characters.");
//		            break;
//		        case 4:
//		            alert.setContentText("Username may not contain symbols.");
//		            break;
//		        case 5:
//		            alert.setContentText("Username has invalid characters after 'P'.");
//		            break;
//		        default:
...
//		    alert.showAndWait();
//
//		    ViewNewAccount.text_Username.requestFocus();
//		    ViewNewAccount.text_Username.selectAll();
//		    return;
//		}
		else {
