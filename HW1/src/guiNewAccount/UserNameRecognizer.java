...
public class UserNameRecognizer {
	 ...
	 * @version 1.02        2026-01-26 changed it so first input must be A-Z, a-z in State 0 and then the error corresponds correctly
	 * 
	 */
	 ...
	 */
	public static int checkForValidUserName(String input) {
		...
		switch (state) {
		case 0:
			// State 0 is not a final state, so we can return a very specific error messageW
			return 1;
