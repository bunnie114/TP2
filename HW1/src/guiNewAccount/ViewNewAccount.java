...
public class ViewNewAccount {
	...
	*/
	...
	// This alert is used should the user not start there username with a alaphebetic char
	protected static Alert alertUsernameStartNotCharError = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter a username longer than 16 chars
	protected static Alert alertUsernameGreaterThan16Error = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter a username less than 4 chars
	protected static Alert alertUsernameLessThan4Error = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter a username containing symbols
	protected static Alert alertUsernameCannotContainSymbolsError = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter double .
	protected static Alert alertUsernameAfterPError = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter nothing as there username
		protected static Alert alertUsernameNotThere = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	private ViewNewAccount() {
		...
		//alertUsernameStartNotCharError, alertUsernameGreaterThan16Error, alertUsernameLessThan4Error 
		//,alertUsernameCannotContainSymbolsError, alertUsernameAfterPError
		
		// If the passwords do not match, this alert dialog will tell the user
		
		alertUsernameNotThere.setTitle("Invalid username");
		alertUsernameNotThere.setHeaderText("UserName cannot be blank");
		alertUsernameNotThere.setContentText("Correct the UserName and try again.");
		
		alertUsernameStartNotCharError.setTitle("Invalid username");
		alertUsernameStartNotCharError.setHeaderText("UserName must start with A-Z or a-z.");
		alertUsernameStartNotCharError.setContentText("Correct the UserName and try again.");
		
		alertUsernameGreaterThan16Error.setTitle("That UserName cannot be used");
		alertUsernameGreaterThan16Error.setHeaderText("Username must not exceed 16 characters.");
		alertUsernameGreaterThan16Error.setContentText("Correct the UserName and try again.");
		
		alertUsernameLessThan4Error.setTitle("Invalid username");
		alertUsernameLessThan4Error.setHeaderText("Username must be at least 4 characters long.");
		alertUsernameLessThan4Error.setContentText("Correct the UserName and try again.");
		
		alertUsernameCannotContainSymbolsError.setTitle("Invalid username");
		alertUsernameCannotContainSymbolsError.setHeaderText("Username may not contain symbols.");
		alertUsernameCannotContainSymbolsError.setContentText("Correct the UserName and try again.");
		
		alertUsernameAfterPError.setTitle("Invalid username");
		alertUsernameAfterPError.setHeaderText("Username has invalid characters after '.'.");
		alertUsernameAfterPError.setContentText("Correct the UserName and try again.");
