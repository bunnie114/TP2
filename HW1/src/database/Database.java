 ...
 */
	 ...
	 * 
	 * <p> Description: Update the password for the specified user in the database and 
	 * update the currentPassword attribute of the Database object.</p>
	 * 
	 * @param userName specifies which user's password to update
