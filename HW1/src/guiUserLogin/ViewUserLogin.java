...
public class ViewUserLogin {
	...
	private ViewUserLogin() {
		...
		setupButtonUI(button_Login, "Dialog", 18, 200, Pos.CENTER, 500, 180);
		...
		setupLabelUI(label_AccountSetupInsrtuctions, "Arial", 18, width, Pos.BASELINE_LEFT, 20, 270);

		// Establish the text input operand field for the invitation code
		setupTextUI(text_Invitation, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 310, true);
		text_Invitation.setPromptText("Enter Invitation Code");

		// Set up the setup button
		setupButtonUI(button_SetupAccount, "Dialog", 18, 200, Pos.CENTER, 500, 310);
		...
		setupLabelUI(label_ForgetPasswordInstructions, "Arial", 18, width, Pos.BASELINE_LEFT, 20, 370);
		
		// set up forgot password button - goes to password reset page
		setupButtonUI(button_forgetPassword, "Dialog", 18, 200, Pos.CENTER, 500, 370);
		...
		setupButtonUI(button_Quit, "Dialog", 18, 250, Pos.CENTER, 300, 440);
