 ...
 * The follow attributes can be updated by 
 * 
 ...
 * @version 1.02        2026-02-03 Added Password change functionality
 *  
 */
...
public class ViewUserUpdate {
	...
	private ViewUserUpdate() {
        ...
        button_UpdatePassword.setOnAction((_) -> {
            ...
            String newPassword = passwordPopUpWindow.View.view(tempPane);
...
//    		
//    		tempPane = new Pane();							// Create a pane within the window
//    		
//    		String result = passwordPopUpWindow.View.view(tempPane);		// Create the GUI
//    		
//    		Scene theScene = new Scene(tempPane, width, height);	// Create the scene
//    		
//    		tempStage.setScene(theScene);						// Set the scene on the stage
//    		
