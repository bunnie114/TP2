...
public class ViewAdminHome {
	...
	*/
	...
	// GUI Area 4: This is to set one time password

		protected static Label label_OnetimePassword = new Label("Set one-time password");

		protected static Label label_OnetimePasswordUsername = new Label("Username");

		protected static TextField text_OnetimePasswordUsername = new TextField();

		protected static Button button_SendOnetimePassword = new Button("Send One-time password");

		protected static Alert alertUsernameError = new Alert(AlertType.INFORMATION);

		protected static Alert alertPasswordSent = new Alert(AlertType.INFORMATION);

		// This is a separator and it is used to partition the GUI for various tasks

		private static Line line_Separator4 = new Line(20, 335, width-20, 335);

		

		// This is a separator and it is used to partition the GUI for various tasks

		private static Line line_Separator5 = new Line(20, 605, width-20, 605);

		

		// GUI Area 5: This is the second of the two action item areas.  This provides a set of other
		...
		private static Line line_Separator6 = new Line(20, 600, width-20,600);



		// GUI Area 6: This is last of the GUI areas.  It is used for quitting the application, logging
		...
		protected static Button button_Quit = new Button("Quit");	// This is the end of the GUI objects for the page.
	...
	*/
	...
	private ViewAdminHome() {
		...
		// GUI area 4
				...
				setupLabelUI(label_OnetimePassword, "Arial", 20, width, Pos.BASELINE_LEFT, 20, 265);

				setupLabelUI(label_OnetimePasswordUsername, "Arial", 16, width, Pos.BASELINE_LEFT, 20, 300);

				setupTextUI(text_OnetimePasswordUsername, "Arial", 16, 360, Pos.BASELINE_LEFT, 130, 295, true);

				setupButtonUI(button_SendOnetimePassword, "Dialog", 16, 230, Pos.CENTER, 500, 295);

				button_SendOnetimePassword.setOnAction((_) -> {ControllerAdminHome.setOnetimePassword(); });
				...
				setupButtonUI(button_ManageInvitations, "Dialog", 16, 250, Pos.CENTER, 20, 360);
				...
				setupButtonUI(button_SetOnetimePassword, "Dialog", 16, 250, Pos.CENTER, 20, 410);
				...
				setupButtonUI(button_DeleteUser, "Dialog", 16, 250, Pos.CENTER, 20, 460);

				button_DeleteUser.setOnAction((_) -> {ControllerAdminHome.deleteUser(); });



				setupButtonUI(button_ListUsers, "Dialog", 16, 250, Pos.CENTER, 20, 510);

				button_ListUsers.setOnAction((_) -> {ControllerAdminHome.listUsers(); });



				setupButtonUI(button_AddRemoveRoles, "Dialog", 16, 250, Pos.CENTER, 20, 560);
				...
				setupButtonUI(button_Logout, "Dialog", 18, 250, Pos.CENTER, 535, 360);

				button_Logout.setOnAction((_) -> {ControllerAdminHome.performLogout(); });

		    

				setupButtonUI(button_Quit, "Dialog", 18, 250, Pos.CENTER, 535, 510);
				...
				theRootPane.getChildren().addAll(
					    ...
					    label_OnetimePassword, label_OnetimePasswordUsername, 

					    text_OnetimePasswordUsername, button_SendOnetimePassword,
