...
public class ViewUserLogin {
	...
	//**
		//This alert is used should the user enter a invalid username
		protected static Alert alertUserNameDoesNotMatch = new Alert(AlertType.INFORMATION);
	...
	private static Label label_ForgetPasswordInstructions = new Label("Forgot your password?");

	private static Button button_forgetPassword = new Button("Reset Password");
	...
	//**
		protected static Label label_UserNameDoesNotMatch = new Label() ; 
	...
	private ViewUserLogin() {
		...
		//**
		setupLabelUI(label_UserNameDoesNotMatch, "Arial", 18, width, Pos.BASELINE_CENTER, 0, 400);
		label_UserNameDoesNotMatch.setStyle("-fx-text-fill: red;");
		...
		// Label and button for forgot password

				setupLabelUI(label_ForgetPasswordInstructions, "Arial", 18, width, Pos.BASELINE_LEFT, 20, 400);

				

				// set up forgot password button - goes to password reset page

				setupButtonUI(button_forgetPassword, "Dialog", 18, 200, Pos.CENTER, 475, 400);

				button_forgetPassword.setOnAction((_) -> {

				    ViewPasswordReset.displayPasswordReset(theStage);
				...
				setupButtonUI(button_Quit, "Dialog", 18, 250, Pos.CENTER, 300, 480);
				...
				theRootPane.getChildren().addAll(
						...
						label_ForgetPasswordInstructions, 
