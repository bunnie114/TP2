...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		//**
		setupLabelUI(label_UserNameDoesNotMatch, "Arial", 20, width, Pos.CENTER, 0, 400);
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				text_AdminPassword2, button_AdminSetup, label_PasswordsDoNotMatch, label_UserNameDoesNotMatch,
				button_Quit);
	}
