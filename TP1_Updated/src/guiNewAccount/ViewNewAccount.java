...
public class ViewNewAccount {
	...
	*/
	...
	public static void displayNewAccount(Stage ps, String ic) {
    	...
    	theRootPane.getChildren().addAll(label_NewUserCreation, label_NewUserLine, text_Username, label_UserNameDoesNotMatch,
	...
	private ViewNewAccount() {
		...
		//Setup the label ****
		setupLabelUI(label_UserNameDoesNotMatch, "Arial", 18, width, Pos.CENTER, 0, 300);
